...
function setup() {
  ...
  selSort.position(center, 10);
  selSize.position(center + 125, 10);
  startButton.position(center + 275, 10);
  newArray.position(center + 400, 10);
...
function runAlgorithm() {
  if (clickable) {
    ...
    console.log('Wait for algorithm to be done');
  }
}
